package com.example.cody.tapwater.services;
...
public class NotificationService extends Service {
    ...
    private class PollTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (prefs.getBoolean("notificationOnOff", true) == true) {
                sendNotification();
            } else {
    ...
    public String notificationDrinksCalculation(int goal, double drank) {
        int remaining = goal - (int) drank;
        String categoryToDrink = (remaining >= 8) ? "an 8oz. glass" : "a 4oz. drink";
        return "Have "+categoryToDrink+" of water now.";
    }
}